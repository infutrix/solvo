...
import { DollarSign, Clock, Truck, GraduationCap, TrendingUp, Users } from 'lucide-react';
  ...
  const benefits = [
    {
      ...
      description: "We offer attractive compensation packages, including health insurance."
    },
    {
      icon: Clock,
    ...
    },
    {
      ...
      description: "We provide a well-maintained vehicle and all necessary safety gear."
    },
    {
      icon: GraduationCap,
      title: "Professional Training",
      description: "Receive comprehensive training to excel in your role and ensure customer satisfaction."
    },
    {
      icon: TrendingUp,
      title: "Career Growth",
      description: "We believe in promoting from within and offer opportunities for advancement."
    },
    {
      icon: Users,
      title: "A Supportive Team",
      description: "Be part of a respectful and supportive community of fellow riders."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-orange-100 leading-relaxed">
                Join the most professional delivery team in the UAE and enjoy competitive earnings, 
                flexibility, and strong support.
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Take the first step towards a rewarding career. Fill out the application below.
            </p>
          </div>
