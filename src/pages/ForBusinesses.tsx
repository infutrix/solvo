  ...
  const services = [
    {
      ...
      description:
        "Ensure your food arrives hot and on time with our dedicated food delivery riders.",
    },
    {
      icon: ShoppingCart,
      title: "E-commerce & Retail",
      description:
        "Meet customer expectations with fast, reliable, and professional last-mile delivery.",
    },
    {
      icon: Heart,
      title: "Pharmacies & Healthcare",
      description:
        "Trust our trained partners for sensitive and urgent medical deliveries.",
    },
    {
      icon: Truck,
      title: "Grocery & Supermarkets",
      description:
        "Handle peak order volumes with a scalable fleet of delivery partners.",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl md:text-2xl mb-10 text-white max-w-4xl mx-auto leading-relaxed drop-shadow-lg">
                Discover how Solvo's outsourced delivery partner solutions can
                reduce your costs, improve efficiency, and enhance your customer
                satisfaction.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Whatever your industry, we have the expertise and fleet to meet
              your delivery needs.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Fill out the form below, and one of our partnership managers will
