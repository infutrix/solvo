            ...
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                <div className="lg:w-1/2 space-y-4">
                  <div className="inline-block bg-orange-400 text-white px-4 py-2 rounded-full text-sm font-semibold">
                    {milestone.year}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <div
                key={index}
                className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 hover:-translate-y-1 group overflow-hidden"
              >
